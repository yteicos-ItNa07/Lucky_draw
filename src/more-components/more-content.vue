    ...
    <div class="accordion accordion-flush" id="accordionFlushExample">
      <div class="accordion-item">
        ...
        <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">Welcome to the Lucky Draw repository! This is a simple and fun Vue.js-based
            application designed to randomly select winners from a list of participants. Whether you're hosting a
            virtual event, a classroom activity, or a promotional campaign, this tool can help you conduct a fair and
